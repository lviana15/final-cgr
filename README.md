...
- [x] Implementar classe de Câmera utilizando PyGLM para gerenciar as matrizes de View e Projection.
- [x] Adicionar controle de input (teclado/mouse) para mover a câmera pela cena.
...
- [x] Adicionar um Skybox (esfera invertida gigante com textura procedural de estrelas) para o fundo.
